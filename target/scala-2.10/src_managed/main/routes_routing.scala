// @SOURCE:/Users/jiyushi1/Desktop/18655/ApacheCMDA-master/ApacheCMDA_Frontend/conf/routes
// @HASH:a39bb0eb0e9cda7cb0e15f293dd6bae7c092e86d
// @DATE:Fri Nov 06 17:00:40 EST 2015
...
// @LINE:43
case controllers_Application_sign25(params) => {
   call { 
        invokeHandler(controllers.Application.sign(), HandlerDef(this, "controllers.Application", "sign", Nil,"GET", """Sign Up Page""", Routes.prefix + """sign"""))
   }
}
...
case controllers_Application_authenticate26(params) => {
   call { 
        invokeHandler(controllers.Application.authenticate(), HandlerDef(this, "controllers.Application", "authenticate", Nil,"POST", """""", Routes.prefix + """signBack"""))
   }
}
